...
选择合适的版本安装，我安装的是最新版的2.2.2
#+begin_src sh
rbenv install 2.2.2
#+end_src

rbenv的工作方式是，在$HOME/.rbenv/shims目录中，存放你选择的版本的ruby。因此，要把这个目录添加到系统PATH中去，在bashrc中修改:
#+begin_src sh
export PATH=$HOME/.rbenv/shims:$PATH
#+end_src

运行rbenv切换到我们安装的2.2.2的环境中去
#+begin_src sh
rbenv global 2.2.2
rbenv rehash
#+end_src
...
同时修改Gemfile，source "https://ruby.taobao.org"
** Q3 rake preview时运行提示： Could not find a JavaScript runtime.
这是由于没有安装js的运行时，建议安装nodejs =sudo apt-get install nodejs=

** Q4 编译最新的ruby 2.2.2时，提示编译有错误
ruby 2.2.2的一些依赖没有安装导致的，需要先安装相关依赖
#+begin_src sh
sudo apt-get install -y autoconf bison build-essential libssl-dev libyaml-dev libreadline6-dev zlib1g-dev libncurses5-dev libffi-dev libgdbm3 libgdbm-dev
#+end_src

参考：http://qiita.com/ringo/items/4351c6aee70ed6f346c8
